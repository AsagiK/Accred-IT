...
CREATE TABLE `accreditation` (
  ...
  `gradesset` int NOT NULL DEFAULT '0',
...
CREATE TABLE `approved_activities_audit` (
  `approved_activities_auditID` int NOT NULL AUTO_INCREMENT,
  `measurement_auditID` int NOT NULL,
  `activity_ID` int NOT NULL,
  `activity_name` varchar(45) NOT NULL,
  `target` int DEFAULT NULL,
...
CREATE TABLE `groupdetails` (
  `Groupdetails_ID` int NOT NULL,
  `Groupdetails_UserID` int NOT NULL,
...
CREATE TABLE `measurement` (
  ...
  `QualityTarget` int DEFAULT NULL,
  `Procedures` varchar(500) DEFAULT NULL,
  `GroupAssigned` int DEFAULT NULL,
...
CREATE TABLE `measurement_audit` (
  `measurement_auditID` int NOT NULL AUTO_INCREMENT,
  `measurement_ID` int NOT NULL,
  `QualityTarget` int DEFAULT NULL,
  `Procedures` varchar(500) DEFAULT NULL,
  `GroupAssigned` int DEFAULT NULL,
...
CREATE TABLE `measurements_activities_audit` (
  `measurement_activities_audit_ID` int NOT NULL AUTO_INCREMENT,
  `measurements_auditID` int DEFAULT NULL,
  `measurement_ID` int NOT NULL,
  `activity_ID` int NOT NULL,
...
CREATE TABLE `measurements_targets_audit` (
  `measurements_targets_auditID` int NOT NULL AUTO_INCREMENT,
  `measurements_auditID` int NOT NULL,
  `measurementID` int NOT NULL,
  `target` int NOT NULL,
  `progress` int DEFAULT NULL,
...
CREATE TABLE `metric` (
  ...
  `cycle_Created` int NOT NULL DEFAULT '0',
...
CREATE TABLE `notifications_read` (
  ...
  `notif_read` tinyint NOT NULL DEFAULT '0'
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE `pending_activities` (
  ...
  `suggested_Score` int DEFAULT NULL,
...
CREATE TABLE `pending_activities_audit` (
  `pending_activities_auditID` int NOT NULL AUTO_INCREMENT,
  `measurement_activities_auditID` int NOT NULL,
  `measurement_auditID` int NOT NULL,
...
CREATE TABLE `plans` (
  ...
  `Plan_MinCycles` int DEFAULT '3',
  `Deadline` varchar(45) DEFAULT NULL,
  `CycleCount` int DEFAULT NULL,
  PRIMARY KEY (`Plan_ID`)
...
CREATE TABLE `scores` (
  ...
  `PriorityLevel` int DEFAULT NULL,
  `PreviousScore` int DEFAULT NULL,
  `CurrentScore` int DEFAULT NULL,
  `PrevOrCurr` int NOT NULL,
