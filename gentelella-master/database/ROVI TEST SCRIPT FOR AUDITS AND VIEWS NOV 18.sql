...
INSERT INTO `activity_evidences` VALUES (2,88,10),(1,86,11),(1,88,11),(1,89,12),(1,90,12),(1,91,12);
...
INSERT INTO `activity_members` VALUES (1,120,1),(2,121,1);
...
INSERT INTO `activity_outputs` VALUES (1,1,'OUTPUT 1',0),(2,1,'OUTPUT 2',0),(3,2,'OUTPUT 3',0),(4,2,'OUTPUT 4',0);
...
INSERT INTO `approved_activities` VALUES (1,'TESTING ACTIVITY 1',NULL,0,'TESTING ACTIVITY 1',NULL,0,'2019-11-30'),(2,'TESTING ACTIVITY 2',NULL,0,'TESTING ACTIVITY 2',NULL,0,'2019-12-27');
...
INSERT INTO `cycle` VALUES (1,'TEST CYCLE 1','2019-11-17','2019-12-31',4,1),(2,'TEST CYCLE 2','2020-01-01','2020-01-31',0,1),(3,'TEST CYCLE 3','2020-02-01','2020-02-29',0,1);
...
INSERT INTO `measurement` VALUES (1,NULL,NULL,20,NULL,'TESTING CREATE MEASUREMENT 1 AUDIT','TESTING CREATE MEASUREMENT 1 AUDIT',NULL,2),(2,NULL,NULL,21,NULL,'TESTING CREATE MEASUREMENT 2 AUDIT','TESTING CREATE MEASUREMENT 2 AUDIT',NULL,2);
...
INSERT INTO `measurement_audit` VALUES (1,1,NULL,NULL,20,NULL,'TESTING CREATE MEASUREMENT 1','TESTING CREATE MEASUREMENT 1',NULL,1,'2019-11-17'),(2,2,NULL,NULL,21,NULL,'TESTING CREATE MEASUREMENT 2','TESTING CREATE MEASUREMENT 2',NULL,1,'2019-11-17');
...
INSERT INTO `measurements_activities` VALUES (1,1),(1,2),(2,2);
...
INSERT INTO `measurements_activities_audit` VALUES (1,1,1,1),(2,1,1,2),(3,2,2,2);
...
INSERT INTO `measurements_targets` VALUES (1,'TESTING TARGET MEASUREMENT 2','80%',1),(1,'TESTING TARGET MEASUREMENT 3','80%',2),(1,'TESTING TARGET MEASUREMENT 1','80%',3),(2,'TARGET 2','50%',4),(2,'TARGET 1','50%',5);
...
INSERT INTO `measurements_targets_audit` VALUES (1,1,1,'TESTING TARGET MEASUREMENT 2','80%',1),(2,1,1,'TESTING TARGET MEASUREMENT 1','80%',3),(3,1,1,'TESTING TARGET MEASUREMENT 3','80%',2),(4,2,2,'TARGET 2','50%',4),(5,2,2,'TARGET 1','50%',5);
...
INSERT INTO `pending_activities` VALUES (10,2,'TESTING ACTIVITY 2',NULL,0,'TESTING SUBMISSION FOR USER EDGELORD FOR ACTIVITY 2',NULL,NULL,1,12,'2019-11-17',1,121,'approved',1),(11,1,'TESTING ACTIVITY 1',NULL,0,'TESTING SUBMISSION FOR USER ROANO SORIA ',NULL,NULL,2,123,'2019-11-17',1,120,'not enough ',1),(12,1,'TESTING ACTIVITY 1',NULL,0,'round 2 test',NULL,NULL,1,12,'2019-11-17',1,120,'approved',1);
...
INSERT INTO `pending_activities_audit` VALUES (8,1,1,12,1,'TESTING ACTIVITY 1',NULL,0,'round 2 test',NULL,NULL,1,12,'2019-11-16',1,120,'approved',1),(9,2,1,10,2,'TESTING ACTIVITY 2',NULL,0,'TESTING SUBMISSION FOR USER EDGELORD FOR ACTIVITY 2',NULL,NULL,1,12,'2019-11-16',1,121,'approved',1),(10,3,2,10,2,'TESTING ACTIVITY 2',NULL,0,'TESTING SUBMISSION FOR USER EDGELORD FOR ACTIVITY 2',NULL,NULL,1,12,'2019-11-16',1,121,'approved',1);
...
-- Dump completed on 2019-11-18  1:36:24
