CREATE DATABASE  IF NOT EXISTS `capstone` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `capstone`;
...
INSERT INTO `activity_evidences` VALUES (1,24,1),(1,25,1),(1,26,1),(1,27,1),(1,29,2),(1,28,2);
...
INSERT INTO `activity_members` VALUES (1,120,1),(1,121,1);
...
INSERT INTO `activity_outputs` VALUES (1,1,'syllabus',0),(2,1,'pdf document of work plan',0);
...
INSERT INTO `approved_activities` VALUES (1,'Get Syllabi',NULL,0,'Kuhanin kay ms stef',NULL,0,'2019-11-10');
...
INSERT INTO `cycle` VALUES (1,'Term 1:2019-2022','2019-11-10','2020-01-04',1);
...
INSERT INTO `measurement` VALUES (1,NULL,NULL,18,1,'% of curriculum and syllabi revised ','based on learner-centered philosophy and Lasallian Guiding Principles',NULL);
...
INSERT INTO `measurements_activities` VALUES (1,1);
...
INSERT INTO `measurements_targets` VALUES (1,'More',NULL),(1,'kek',NULL),(1,'Target',NULL);
...
INSERT INTO `pending_activities` VALUES (1,1,'Get Syllabi',NULL,0,'ADMIN SUBMISSION',NULL,NULL,NULL,10,'2019-11-09',1,35),(2,1,'Get Syllabi',NULL,0,'TESTING SUBMISSION OF ROANO SORIA ID NUMBER 120',NULL,NULL,NULL,20,'2019-11-09',1,120);
...
-- Dump completed on 2019-11-10  3:52:16
